...
function api:start(episode, seed, params)
  ...
  --adding apples
  maze:setEntityCell(7, 5, 'A')
  maze:setEntityCell(7, 7, 'A')
  maze:setEntityCell(7, 9, 'A')
  maze:setEntityCell(5, 9, 'A')
  maze:setEntityCell(5, 11, 'A')
  maze:setEntityCell(7, 11, 'A')
  maze:setEntityCell(8, 11, 'A')
