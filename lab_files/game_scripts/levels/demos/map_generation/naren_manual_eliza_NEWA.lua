...
function api:start(episode, seed, params)
  ...
  --add apples 
  maze:setEntityCell(3, 10, 'A')
  maze:setEntityCell(4, 10, 'A')
  maze:setEntityCell(5, 12, 'A')
  maze:setEntityCell(7, 12, 'A')
  maze:setEntityCell(8, 10, 'A')
  maze:setEntityCell(10, 8, 'A')
  maze:setEntityCell(10, 10, 'A')
  maze:setEntityCell(10, 6, 'A')
