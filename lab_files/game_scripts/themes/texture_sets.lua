...
texture_sets.CAPTURE_THE_FLAG = {
    variations = {
        ...
        C = {
            floor = {{tex = 'map/lab_games/lg_style_01_floor_orange_bright'}},
            wall = {{tex = 'map/lab_games/lg_style_02_wall_yellow'}},
            wallDecals = decals.decals,
        },

        D = {
            floor = {{tex = 'map/lab_games/lg_style_02_floor_green'}},
            wall = {{tex = 'map/lab_games/lg_style_01_wall_green'}},
            wallDecals = decals.decals,
        },

        E = {
            floor = {{tex = 'map/lab_games/lg_style_05_floor_orange'}},
            wall = {{tex = 'map/lab_games/lg_style_03_wall_orange_bright'}},
            wallDecals = decals.decals,
        },  
        F = {
            floor = {{tex = 'map/lab_games/lg_style_05_floor_gray'}},
            wall = {{tex = 'map/lab_games/lg_style_03_wall_gray_bright'}},
            wallDecals = decals.decals,
        },
        G = {
            floor = {{tex = 'map/lab_games/lg_style_02_floor_green'}},
            wall = {{tex = 'map/lab_games/lg_style_01_wall_green_bright'}},
            wallDecals = decals.decals,
        },           
    },
